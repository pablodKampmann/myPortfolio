...
export default function Work() {
  ...
  const languageTexts = {
    eng: {
      title: "Projects",
      info_1:
        "Administrative application for a health clinic, especially oriented to the area of ​​dentistry. This tool provides a comprehensive solution for managing patients, shifts, medical records, treatments, finances, among others.",
      info_2:
        "Social mobile application that helps you find a roommate. It offers various forms of interaction, such as 'matches', likes, chats and user profiles, thus facilitating the search and choice of the ideal partner.",
      info_3:
        "YouTube Music clone with responsive design for all devices. The clone has been created manually, replicating the original design without copying code.",
      info_4:
        "Completely responsive template that includes a login page, a registration page and its two mobile versions.",
      info_5:
        "Administrative application designed for sellers, which facilitates the management of customers, products, orders and other key business elements.",
      category_1: "Desktop",
      category_2: "Mobile",
    },
    spa: {
      ...
      info_4:
        "Template completamente responsive que incluye una página de inicio de sesión, otra de registro y sus dos versiones móviles.",
      info_5:
        "Aplicación administrativa diseñada para vendedores, que facilita la gestión de clientes, productos, pedidos y otros elementos clave del negocio.",
          ...
          <div className="">
            ...
            >
              <div className="font-bold mr-auto desktop:text-xl w-[30%] ">
                ...
                <div
                  className={`bg-white w-fit px-3 py-2 mt-4 rounded-lg shadow-2xl ${classes?.bgOpacityLinks}`}
                >
              ...
              <Image
                ...
                className={`${classes?.opacityImages} mr-10 rounded-lg group-hover:opacity-100 shadow-2xl  group-hover:scale-110 trasform transition-all duration-700 w-[60%] h-auto`}
                quality={100}
                width={1919}
                height={917}
                priority={true}
            ...
            >
              {!imageIsLoad ? (
                ...
                <Image
                  ...
                  blurDataURL={imageBlur}
                  onLoad={() => setImageIsLoad(true)}
                  className={`${classes?.opacityImages} rounded-lg shadow-2xl opacity-50 group-hover:opacity-100  group-hover:scale-110 ml-10 trasform transition-all duration-700 w-[60%] h-auto`}
                  quality={100}
                  width={1920}
                  height={1080}
                  priority={true}
            ...
            >
              {!imageIsLoad ? (
                ...
                <Image
                  ...
                  blurDataURL={imageBlur}
                  onLoad={() => setImageIsLoad(true)}
                  className={`${classes?.opacityImages} rounded-lg ml-10 flex shadow-2xl opacity-50 group-hover:opacity-100 group-hover:scale-110 trasform transition-all duration-700 w-[60%] h-auto`}
                  quality={100}
                  width={1919}
                  height={918}
                  priority={true}
            ...
            >
              <div className="font-bold desktop:text-xl mr-auto w-[30%]">
                ...
                <div
                  className={`bg-white w-[80%] px-3 py-2 mt-4 rounded-lg shadow-2xl ${classes?.bgOpacityLinks}`}
                >
                  <h2 className="flex justify-start items-center ">
                    Deploy <GrDeploy className="ml-2" />
                  </h2>
              ...
              {!imageIsLoad ? (
                ...
                <Image
                  ...
                  blurDataURL={imageBlur}
                  onLoad={() => setImageIsLoad(true)}
                  className={`${classes?.opacityImages} rounded-lg mr-10 flex shadow-2xl opacity-50 group-hover:opacity-100  group-hover:scale-110 trasform transition-all duration-700 w-[60%] h-auto`}
                  quality={100}
                  width={1919}
                  height={914}
                  priority={true}
