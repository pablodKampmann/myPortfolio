...
export default function MobileVersion({
  ...
  return (
    <div className="relative">
      ...
      >
        <div
          className={`${classes?.textMain} flex border-b-2 h-16  ${classes?.borderColor} space-x-4 p-2 justify-start items-center  `}
        >
          <button
      ...
      {/* Navbar */}
      <div
        className={`w-full flex z-20 fixed top-0 left-0 right-0 justify-between items-center ${classes?.bgMain} border-b-2 ${openSideBar ? `border-transparent` : `${classes?.borderColor}`}  transition select-none duration-200 ${classes?.bgMainOpacity} h-16`}
      >
        ...
        <div
          className={`${classes?.textMain} flex space-x-4  justify-end items-center mr-4`}
        >
          <button
            onClick={() => setOpenSideBar(!openSideBar)}
