...
export default function Tech() {
    ...
    const updateClassesTones = () => {
      ...
      switch (colorMain) {
        case "emerald":
          ...
          textColorTitleIcon =
            tone === "dark" ? "text-emerald-700" : "text-emerald-700";
        ...
        case "rose":
          ...
          textColorCategory =
            tone === "dark" ? "text-rose-400" : "text-rose-600";
          textColorTitleIcon =
            tone === "dark" ? "text-rose-700" : "text-rose-700";
        ...
        case "blue":
          ...
          textColorTitleIcon =
            tone === "dark" ? "text-blue-700" : "text-blue-700";
        ...
        case "yellow":
          ...
          textColorCategory =
            tone === "dark" ? "text-yellow-400" : "text-yellow-600";
          textColorTitleIcon =
            tone === "dark" ? "text-yellow-700" : "text-yellow-700";
  ...
  return (
    <div
      className={`${classes?.textColorClass} flex flex-col  justify-center items-center h-full pb-[6%]`}
    >
      <div
      ...
      <TbArrowWaveRightUp
        size={50}
        className={`${classes?.textColorArrow} opacity-20  mt-4 mb-6 rotate-90`}
      />
      <div className="flex justify-center select-none space-x-4 items-center">
        <button
          onClick={() => setOption("languages")}
          className={`${option === "languages" ? `${classes?.bgColorTitle}` : `${classes?.hoverColorButtons} ${classes?.hoverOpacityButtons}`} transition duration-200 rounded-md laptop:text-lg desktop:text-xl  px-2 py-1 cursor-pointer`}
        >
          {texts?.option_1}
        </button>
        <button
          onClick={() => setOption("frontend")}
          className={`${option === "frontend" ? `${classes?.bgColorTitle}` : `${classes?.hoverColorButtons} ${classes?.hoverOpacityButtons}`} transition duration-200 rounded-md laptop:text-lg desktop:text-xl px-2 py-1 cursor-pointer`}
        >
          {texts?.option_2}
        </button>
        <button
          onClick={() => setOption("backend")}
          className={`${option === "backend" ? `${classes?.bgColorTitle}` : `${classes?.hoverColorButtons} ${classes?.hoverOpacityButtons}`} transition duration-200  rounded-md laptop:text-lg desktop:text-xl px-2 py-1 cursor-pointer`}
        >
          {texts?.option_3}
        </button>
      </div>
          ...
          <div>
            <div className="absolute space-x-2 flex laptop:text-sm desktop:text-base justify-center items-center top-0.5 left-2">
              <button
                ...
                className={`${category === "primary" ? `${classes?.textColorCategory} underline` : `${classes?.textColorClass}`}  mr-2 cursor-pointer`}
              >
                {texts?.category_1}
              </button>
              /
            ...
            {category === "primary" && (
              <div className="space-x-6 flex justify-center mt-4 items-center">
                <div className="flex flex-col group hover:cursor-help	 justify-center items-center">
                  <Image
                    className="transition-transform  duration-300 w-[110px] h-[110px] transform group-hover:scale-110  group-hover:-translate-y-2"
                    width={110}
                    height={110}
                    priority={true}
                    ...
                    alt="tailwind-icon"
                  />
                  <p className="text-sm tracking-widest group-hover:opacity-100 opacity-0 mt-1.5 transition duration-150 font-[600]">
                    Tailwind
                  </p>
                </div>
          ...
          <div className="space-x-6 flex justify-center mt-4 items-center">
            ...
            <div className="flex flex-col group justify-center items-center hover:cursor-help">
              <Image
                ...
                height={110}
                priority={true}
                src="microsoftsql-icon.svg"
                alt="microsoftsql-icon"
              />
              <p className="text-sm tracking-widest group-hover:opacity-100 opacity-0 mt-1.5 transition duration-150 font-[600]">
                SqlServer
              </p>
